	  ...
	  createTween: function () {
	    ...
	    var tween = new mojs.Tween({
	      ...
	      onUpdate: function (p) {
	        ...
	        mojs.h.style(_this.moleEl, "transform", "translate(" + 25 + "px, " + (-240 + 240 * e.cubic["in"](p)) + "px) scaleX(" + (1 - 0.35 * e.cubic["in"](p)) + ")");
	        mojs.h.style(_this.moleHandEl, "transform", "rotate(" + (94.5 + 94.5 * e.quad["in"](p)) + "deg) scaleY(1.1)");
