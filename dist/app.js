...
/***/ function(module, exports, __webpack_require__) {
	...
	var setPrototypesOf = function setPrototypesOf(trg) {
	  ...
	  var handlers = {
	    get: function get(target, key, context) {
	      if (_core.Reflect.has(target, key)) {
	        return _core.Reflect.get(target, key, context);
	      } else {
	        for (var _iterator = _core.$for.getIterator(target[Symbol["for"]("[[Prototype]]")]), _step; !(_step = _iterator.next()).done;) {
	          var P = _step.value;
	          if (_core.Reflect.has(P, key, context)) {
	            return _core.Reflect.get(P, key, context);
	          }
	        }
	      }
	    }
