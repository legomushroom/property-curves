...
/***/ function(module, exports, __webpack_require__) {
	...
	// SCENES
	var cubeFall = __webpack_require__(46),
	    cubeFallEffects = __webpack_require__(47),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mojs = __webpack_require__(3);
	var effects = __webpack_require__(47);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var moleOpen = {
	  ...
	  vars: function () {
	    ...
	    this.whooshSound1 = new Howl({ urls: ["sounds/whoosh-1." + this.soundFileType], volume: 0.4, rate: 1.4 });
	  },
	  createTween: function () {
	    var _this = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var moleRantingHand = {
	  ...
	  vars: function () {
	    this.rantSound1 = new Howl({ urls: ["sounds/rant-1-1." + this.soundFileType], rate: 1.25, volume: 0.65 });
	    this.rantSound2 = new Howl({ urls: ["sounds/rant-1-2." + this.soundFileType], rate: 1.25, volume: 0.65 });
	    this.rantSound3 = new Howl({ urls: ["sounds/rant-1-3." + this.soundFileType], rate: 1.25, volume: 0.65 });
	  },
	  createTween: function () {
	    var _this = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var moleRantingSearch = {
	  ...
	  vars: function () {
	    ...
	    this.doorShadowEl = document.querySelector("#js-door-shadow");
	    this.doorHandleShadowEl = document.querySelector("#js-door-handle-shadow");
	    this.doorOpenSoundSmall = new Howl({ urls: ["sounds/door-open-small-1." + this.soundFileType], rate: 1.9, volume: 0.6 });
	    this.wehSound1 = new Howl({ urls: ["sounds/ugh-2." + this.soundFileType], volume: 0.35, rate: 1.25 });
	    this.wehSound2 = new Howl({ urls: ["sounds/ugh-1." + this.soundFileType], volume: 0.35, rate: 1.35 });
	  },
	  createTween: function () {
	    var _this = this;
	    var timeLine = new mojs.Timeline();
	  ...
	  createTween: function createTween() {
	    ...
	    var moveDownTween = new mojs.Tween({
	      ...
	      onUpdate: function (p) {
	        ...
	        h.style(_this.moleEl, "transform", "translate(" + 25 + "px, " + (-240 + 360 * cubicInP) + "px) " + _this.zHack);
