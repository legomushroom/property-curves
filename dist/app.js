...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var main = {
	  ...
	  showHiddenParts: function showHiddenParts() {
	  ...
	  loadSounds: function loadSounds() {
	    ...
	    this.fall2Sound = new Howl({ urls: [soundUrl], rate: 0.9, volume: 0.8, onload: this.tryToLaunch.bind(this) });
	    this.fall3Sound = new Howl({ urls: [soundUrl], rate: 0.8, volume: 0.5, onload: this.tryToLaunch.bind(this) });
	    this.fall4Sound = new Howl({ urls: [soundUrl], rate: 0.7, volume: 0.4, onload: this.tryToLaunch.bind(this) });
	    this.fall5Sound = new Howl({ urls: [soundUrl], rate: 0.6, volume: 0.3, onload: this.tryToLaunch.bind(this) });

	    this.whooshSound1 = new Howl({ urls: ["" + soundBase + "whoosh-1." + this.soundFileType], volume: 0.4, rate: 1.4, onload: this.tryToLaunch.bind(this) });
	    ...
	    this.doorOpenSoundSmall = new Howl({ urls: ["" + soundBase + "door-open-small-1." + this.soundFileType], rate: 1.9, volume: 0.6, onload: this.tryToLaunch.bind(this) });
	    this.wehSound1 = new Howl({ urls: ["" + soundBase + "ugh-2." + this.soundFileType], volume: 0.35, rate: 1.25, onload: this.tryToLaunch.bind(this) });
	    this.wehSound2 = new Howl({ urls: ["" + soundBase + "ugh-1." + this.soundFileType], volume: 0.35, rate: 1.35, onload: this.tryToLaunch.bind(this) });

	    this.rantSound1 = new Howl({ urls: ["" + soundBase + "rant-1-1." + this.soundFileType], rate: 1.25, volume: 0.65, onload: this.tryToLaunch.bind(this) });
	    this.rantSound2 = new Howl({ urls: ["" + soundBase + "rant-1-2." + this.soundFileType], rate: 1.25, volume: 0.65, onload: this.tryToLaunch.bind(this) });
	    this.rantSound3 = new Howl({ urls: ["" + soundBase + "rant-1-3." + this.soundFileType], rate: 1.25, volume: 0.65, onload: this.tryToLaunch.bind(this) });

	    this.doorCloseSound = new Howl({ urls: ["" + soundBase + "door-close-1." + this.soundFileType], rate: 1.5, volume: 0.65, onload: this.tryToLaunch.bind(this) });
	    this.boomSound = new Howl({ urls: ["" + soundBase + "fall-kick-1." + this.soundFileType], rate: 0.5, onload: this.tryToLaunch.bind(this) });
	    this.fallingSound = new Howl({ urls: ["" + soundBase + "falling-1." + this.soundFileType], rate: 4.5, volume: 0.05, onload: this.tryToLaunch.bind(this) });
	  },

	  tryToLaunch: function tryToLaunch() {
	    this.soundsLoadedCnt++;
	    if (this.soundsLoadedCnt >= 19 && !this.isLaunched) {
	      this.onSoundsLoaded();
	    }
	  },
	  ...
	  onSoundsLoaded: function onSoundsLoaded() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var cubeFall = __webpack_require__(31),
	    cubeFallEffects = __webpack_require__(32),
	    cubeAnticipation = __webpack_require__(34);
	...
	var cube = {
	  ...
	  vars: function () {
	    ...
	    window.addEventListener("resize", function () {
	      _this.translateY = window.innerHeight;
	    });
	  },
	  ...
	  createTween: function () {
	    ...
	    this.cubeFallTween = new mojs.Tween({
	      ...
	      onUpdate: function (progress) {
	        ...
	        mojs.h.setPrefixedStyle(_this.cubeEl, "transform", "translate3d(0, " + (-_this.translateY + _this.translateY * bounceProgress) + "px, 0)");
	        mojs.h.setPrefixedStyle(_this.cubeSquashEl, "transform", "scaleX(" + (1 + squashProgress) + ") scaleY(" + (1 - squashProgress) + ")");
	        mojs.h.setPrefixedStyle(_this.shadowEl, "transform", "scale(" + (1 + scaleProgress + squashProgress) + ") rotateX(" + -28 * squashProgress + "deg) rotateY(" + 28 * squashProgress + "deg) translateZ(" + -4 * squashProgress + "px)");
	  ...
	  createTween: function () {
	    ...
	    this.cubeAnticipationTween = new mojs.Tween({
	      ...
	      onUpdate: function (p) {
	        ...
	        mojs.h.style(_this.cubeEl, "transform", "translate3d(0, " + -_this.translateY * (1 - anticipationYProgress) + "px, 0)");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// SCENES
	var doorOpen = __webpack_require__(52);
	var moleOpen = __webpack_require__(51);
	  ...
	  createTween: function () {
	    ...
	    var tween = new mojs.Tween({
	      ...
	      onStart: function () {
	        if (!_this.isMobile()) {
	          saliva.run();
	        };salivaLauncher.run();_this.isSound && _this.sighSound1.play();
	      },
	      onUpdate: function (p) {
	        ...
	        mojs.h.style(_this.moleEl, "transform", "skewX(" + (75 * skewP - 5 * noizeP) + "deg) skewY(" + 15 * noizeP + "deg) " + _this.zHack);
	        mojs.h.style(_this.moleHandEl, "transform", "rotate(" + (_this.handAngle * handP + 30 * noizeP) + "deg) " + _this.zHack);
	        mojs.h.style(_this.moleHandLeftEl, "transform", "rotate(" + (100 * skewP - 15 * noizeP) + "deg) translateY(" + -100 * skewP + "px) " + _this.zHack);
	        mojs.h.style(_this.moleMouthEl, "transform", "scale(" + (mouthP + 3 * noizeP) + ") translate(" + -30 * skewP + "px, 0) " + _this.zHack);
	        mojs.h.style(_this.moleGlassesEl, "transform", "translateY(" + 20 * noizeP + "px) " + _this.zHack);
	        mojs.h.style(_this.moleGlassesLeftEl, "transform", "translateY(" + 10 * noizeP + "px) " + _this.zHack);
	        ...
	        mojs.h.style(_this.moleEyeEl, "transform", "rotate(" + 37 * n_squintP + "deg) translate(" + 7 * n_squintP + "px, " + -4 * n_squintP + "px) scaleX(" + (1 - 0.4 * n_squintP) + ") " + _this.zHack);
	      }
	    });
	    // tween.start();
	  ...
	  createTween: function () {
	    ...
	    var tween = new mojs.Tween({
	      ...
	      onUpdate: function (p) {
	        ...
	        mojs.h.style(_this.moleEl, "transform", "skewX(" + 9 * bodySkewP + "deg) scale(" + (1 - 0.15 * riseP) + ", " + (1 + 0.15 * riseP) + ") translate(0, " + -17 * riseP + "px) " + _this.zHack);
	        mojs.h.style(_this.moleHandEl, "transform", "rotate(" + (29.5 + 65 * bodySkewP) + "deg) scaleY(" + (1 + 0.1 * bodySkewP) + ") translateY(" + -15 * riseP + "px) " + _this.zHack);
	        mojs.h.style(_this.moleHandLeftEl, "transform", "rotate(" + 20 * bodySkewP + "deg) translate(" + 30 * bodySkewP + "px, " + (-10 * bodySkewP - 10 * riseP) + "px) " + _this.zHack);
	        ...
	        mojs.h.style(_this.moleEyeEl, "transform", "rotate(" + 60 * riseP + "deg) translate(" + 7 * riseP + "px, " + -4 * riseP + "px) scaleX(" + (1 - 0.9 * riseP) + ") " + _this.zHack);

	        mojs.h.style(_this.moleMouthEl, "transform", "scale(" + (0.3 + 2.4 * riseP) + ") " + _this.zHack);
	      }
	    });
	    ...
	    var tween2 = new mojs.Tween({
	      ...
	      onUpdate: function (p) {
	        var riseP = riseC(p);
	        mojs.h.setPrefixedStyle(_this.moleConeEl, "transform", "rotateX(" + 210 * riseP + "deg) " + _this.zHack);
	        mojs.h.setPrefixedStyle(_this.moleGlassesEl, "transform", "translateY(" + -25 * riseP + "px) " + _this.zHack);
	        mojs.h.setPrefixedStyle(_this.moleGlassesLeftEl, "transform", "translateY(" + -25 * riseP + "px) " + _this.zHack);
	      }
	    });
	...
	var close = {
	  ...
	  createTween: function createTween() {
	    ...
	    var moveDownTween = new mojs.Tween({
	      ...
	      onComplete: function () {
	        _this.resetParts();
	        _this.moleHandCircleEl.style.opacity = 0;
	        h.style(_this.moleHandEl, "transform", "");
	        h.style(_this.moleHatEl, "transform", "");
	        _this.moleHatEl.style["z-index"] = 4;
	        _this.moleEyeLashEl.setAttribute("d", "M0,0 Q 6.5 10, 13 0");
	        _this.moleEyeLashEl.setAttribute("stroke-width", 2);
	        mojs.h.style(_this.moleEyeEl, "transform", "");
	        h.style(_this.moleGlassesEl, "transform", "");
	        h.style(_this.moleGlassesLeftEl, "transform", "");
	      },
	      onUpdate: function (p) {
	        ...
	        h.style(_this.moleEl, "transform", "translate(" + 25 + "px, " + (-240 + 360 * cubicInP) + "px) translateZ(-1px)");
	        // (p === 1) && (this.moleEl.style['z-index'] = 0);

	        h.style(_this.moleInnerEl, "transform", "skewX(" + 9 * (1 - p) + "deg) scale(" + (1 - 0.2 * cubicInP) + ", " + (1 + 0.2 * cubicInP) + ") " + _this.zHack);

	        h.style(_this.moleHandEl, "transform", "rotate(" + (94.5 + 100.5 * quadInP) + "deg) scaleY(" + (1.1 - 0.1 * quadInP) + ") translateY(" + 70 * quadInP + "px) " + _this.zHack);
	        h.style(_this.moleHandLeftEl, "transform", "rotate(" + (20 - 20 * quadInP) + "deg) translate(" + (30 - 35 * quadInP) + "px, " + (-10 - 70 * quadInP) + "px) " + _this.zHack);

	        h.style(_this.doorEl, "transform", "rotateY(" + (-125 + 125 * cubicInP) + "deg) scaleX(" + (0.75 + 0.25 * expoInP) + ") translate(" + 8 * expoInP + "px, " + 8 * expoInP + "px) " + _this.zHack);
	        h.style(_this.doorShadowEl, "transform", "scaleX(" + (1 - 1.65 * cubicInP) + ") " + _this.zHack);

	        h.style(_this.moleConeEl, "transform", "rotateX(" + 150 * quadInP + "deg) rotateY(" + -14 * quadInP + "deg) translateY(" + -5 * quadInP + "px) " + _this.zHack);
	        _this.moleConeShadowEl.style.opacity = 1 - p;
	        h.style(_this.moleHatEl, "transform", "translateY(" + -35 * expoInP + "px) " + _this.zHack);
	        _this.moleHatEl.style["z-index"] = Math.round(12 - 12 * p);

	        h.style(_this.moleGlassesEl, "transform", "translateY(" + -85 * expoInP + "px) " + _this.zHack);
	        h.style(_this.moleGlassesLeftEl, "transform", "translateY(" + -85 * expoInP + "px) " + _this.zHack);

	        _this.moleEyeLashEl.setAttribute("d", "M0,0 Q 6.5 " + 10 * p + ", 13 0");
	        _this.moleEyeLashEl.setAttribute("stroke-width", 2 + 1.5 * p);
	        mojs.h.style(_this.moleEyeEl, "transform", "translate(" + 7 * p + "px, " + -5 * p + "px) scaleX(" + (1 - 0.4 * p) + ") " + _this.zHack);
	        mojs.h.style(_this.moleMouthInnerEl, "transform", "scale(" + (0.3 - 0.3 * p) + ") " + _this.zHack);
	      }
	    });
	    ...
	    var staggerAddTween = this.isMobile() ? new mojs.Timeline() : burstStagger;
	    var doorWaveAddTween = this.isMobile() ? new mojs.Timeline() : doorWaveTween;

	    this.closeTimeline.add(moveDownTween, closeSoundLauncher).append([staggerAddTween, doorWaveAddTween, noiseTween]);
