...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = "data:image/svg+xml;base64,"
	  ...
	  createTween: function () {
	    ...
	    var tween = new mojs.Tween({
	      ...
	      onUpdate: function (p) {
	        ...
	        mojs.h.style(_this.moleInnerEl, "transform", "skewX(" + 9 * (1 - p) + "deg) scale(" + (1 - 0.35 * squashP) + ", " + (1 + 0.35 * squashP) + ")");
	        mojs.h.style(_this.moleEl, "transform", "translate(" + 25 + "px, " + (-240 - 70 * positionP) + "px)");

	        var doorAngleP = doorAngleC(p);

	        mojs.h.style(_this.doorEl, "transform", "rotateY(" + (-125 + 254 * doorAngleP) + "deg) scaleX(" + (0.75 + 0.25 * mojs.easing.expo["in"](p)) + ") translate(" + 8 * mojs.easing.expo["in"](p) + "px, " + 8 * mojs.easing.expo["in"](p) + "px)");
	        mojs.h.style(_this.doorShadowEl, "transform", "scaleX(" + (1 - 1.65 * doorAngleP) + ")");
	        mojs.h.style(_this.moleHandEl, "transform", "rotate(" + (94.5 - 94.5 * doorAngleP) + "deg)");

	        mojs.h.style(_this.moleHandLeftEl, "transform", "rotate(" + (20 - 40 * squashP) + "deg) translate(" + (30 - 35 * squashP) + "px, " + (-10 - 25 * squashP) + "px)");
