	  ...
	  createTween: function () {
	    ...
	    this.cubeFallTween = new mojs.Tween({
	      ...
	      onUpdate: function (progress) {
	        ...
	        mojs.h.setPrefixedStyle(_this.shadowEl, "transform", "scale(" + (1 + scaleProgress + squashProgress) + ") rotateX(" + -28 * squashProgress + "deg) rotateY(" + 28 * squashProgress + "deg)");
	...
	var cubeFall = {
	  ...
	  createTween: function () {
	    ...
	    this.cubeAnticipationTween = new mojs.Tween({
	      ...
	      duration: 0.85 * this.fallDuration * this.s,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var moleRantingHand = {
	  ...
	  vars: function () {
	    this.rantSound1 = new Howl({ urls: ["sounds/rant-1-1.wav"], rate: 1.25, volume: 0.65 });
	    this.rantSound2 = new Howl({ urls: ["sounds/rant-1-2.wav"], rate: 1.25, volume: 0.65 });
	    this.rantSound3 = new Howl({ urls: ["sounds/rant-1-3.wav"], rate: 1.25, volume: 0.65 });
	  },
	  createTween: function () {
	    var _this = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var close = {
	  ...
	  vars: function vars() {
	    ...
	    this.fallingSound = new Howl({ urls: ["./sounds/falling-1.wav"], rate: 4.5, volume: 0.05 });
	  },
