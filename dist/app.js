	  ...
	  createTween: function () {
	    ...
	    var tween = new mojs.Tween({
	      ...
	      onUpdate: function (p) {
	        ...
	        mojs.h.style(_this.moleEl, "transform", "translate(" + 25 + "px, " + (-240 + 260 * e.cubic["in"](p)) + "px) scale(" + (1 - 0.2 * e.cubic["in"](p)) + ", " + (1 + 0.2 * e.cubic["in"](p)) + ")");
	        mojs.h.style(_this.moleHandEl, "transform", "rotate(" + (94.5 + 100.5 * e.quad["in"](p)) + "deg) scaleY(1.1)");
	        mojs.h.style(_this.moleHandLeftEl, "transform", "rotate(" + (20 - 20 * e.quad["in"](p)) + "deg) translate(" + (30 - 35 * e.quad["in"](p)) + "px, " + (-10 - 25 * e.quad["in"](p)) + "px)");

	        // var doorAngleP = doorAngleC(p);

	        mojs.h.style(_this.doorEl, "transform", "rotateY(" + (-125 + 125 * e.cubic["in"](p)) + "deg) scaleX(" + (0.75 + 0.25 * mojs.easing.expo["in"](p)) + ") translate(" + 8 * mojs.easing.expo["in"](p) + "px, " + 8 * mojs.easing.expo["in"](p) + "px)");
	        mojs.h.style(_this.doorShadowEl, "transform", "scaleX(" + (1 - 1.65 * e.cubic["in"](p)) + ")");
