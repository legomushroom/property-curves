...
var moleRantingHand = {
  ...
  vars: function () {
    this.rantSound1 = new Howl({ urls: ['sounds/rant-1-1.wav'], rate: 1.25, volume: .65 });
    this.rantSound2 = new Howl({ urls: ['sounds/rant-1-2.wav'], rate: 1.25, volume: .65 });
    this.rantSound3 = new Howl({ urls: ['sounds/rant-1-3.wav'], rate: 1.25, volume: .65 });
  },
