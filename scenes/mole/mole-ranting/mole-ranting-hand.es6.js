...
var moleRantingHand = {
  ...
  vars: function () {
    this.rantSound1 = new Howl({ urls: [`sounds/rant-1-1.${this.soundFileType}`], rate: 1.25, volume: .65 });
    this.rantSound2 = new Howl({ urls: [`sounds/rant-1-2.${this.soundFileType}`], rate: 1.25, volume: .65 });
    this.rantSound3 = new Howl({ urls: [`sounds/rant-1-3.${this.soundFileType}`], rate: 1.25, volume: .65 });
  },
